...
#   Unknown type 'SYS.AQ$_SUBSCRIBERS' for column 'subscribers'
  ...
  create_table "def$_destination", id: false, force: :cascade do |t|
    ...
    t.string  "alternate",                  limit: 1,    default: "F"
  ...
  create_table "logmnr_con$", id: false, force: :cascade do |t|
  ...
  add_index "logmnr_con$", ["logmnr_uid", "con#"], name: "logmnr_i1con$"
  ...
  create_table "logmnrc_con_gg", id: false, force: :cascade do |t|
  ...
  add_index "logmnrc_con_gg", ["logmnr_uid", "baseobj#", "baseobjv#", "commit_scn"], name: "logmnrc_i1congg"
  add_index "logmnrc_con_gg", ["logmnr_uid", "drop_scn"], name: "logmnrc_i2congg"

  create_table "logmnrc_concol_gg", id: false, force: :cascade do |t|
    t.decimal "logmnr_uid",              null: false
    t.decimal "con#",                    null: false
    t.decimal "commit_scn",              null: false
    t.decimal "intcol#",                 null: false
  ...
  create_table "logmnrc_ind_gg", id: false, force: :cascade do |t|
    t.decimal "logmnr_uid",              null: false
    t.decimal "obj#",                    null: false
    t.string  "name",       limit: 128,  null: false
    t.decimal "commit_scn",              null: false
    ...
    t.decimal "flags",                   null: false
    t.decimal "owner#",                  null: false
    t.string  "ownername",  limit: 128,  null: false
    t.decimal "spare1"
    t.decimal "spare2"
    t.decimal "spare3"
    t.string  "spare4",     limit: 4000
  ...
  add_index "logmnrc_ind_gg", ["logmnr_uid", "baseobj#", "baseobjv#", "commit_scn"], name: "logmnrc_i1indgg"
  add_index "logmnrc_ind_gg", ["logmnr_uid", "drop_scn"], name: "logmnrc_i2indgg"

  create_table "logmnrc_indcol_gg", id: false, force: :cascade do |t|
    t.decimal "logmnr_uid",              null: false
    t.decimal "obj#",                    null: false
    t.decimal "commit_scn",              null: false
    t.decimal "intcol#",                 null: false
  ...
  create_table "logmnrc_seq_gg", id: false, force: :cascade do |t|
    t.decimal "logmnr_uid",              null: false
    t.decimal "obj#",                    null: false
    t.decimal "commit_scn",              null: false
    t.decimal "drop_scn"
    ...
    t.decimal "owner#",                  null: false
    t.string  "ownername",  limit: 128,  null: false
    t.string  "objname",    limit: 128,  null: false
    t.decimal "seqcache"
    t.decimal "seqinc"
    t.decimal "spare1"
    t.decimal "spare2"
  ...
  add_index "logmnrc_seq_gg", ["logmnr_uid", "drop_scn"], name: "logmnrc_i2seqgg"

  create_table "logmnrggc_gtcs", id: false, force: :cascade do |t|
    t.decimal  "logmnr_uid",                               null: false
    t.decimal  "obj#",                                     null: false
    t.decimal  "objv#",                                    null: false
    t.decimal  "segcol#",                                  null: false
  ...
  add_index "logmnrggc_gtcs", ["logmnr_uid", "obj#", "objv#", "segcol#", "intcol#"], name: "logmnrggc_i2gtcs"

  create_table "logmnrggc_gtlo", id: false, force: :cascade do |t|
    t.decimal  "logmnr_uid",                      null: false
    t.decimal  "keyobj#",                         null: false
    t.decimal  "lvlcnt",                          null: false
    t.decimal  "baseobj#",                        null: false
  ...
  add_index "logmnrggc_gtlo", ["logmnr_uid", "baseobj#", "baseobjv#"], name: "logmnrggc_i2gtlo"
  add_index "logmnrggc_gtlo", ["logmnr_uid", "drop_scn"], name: "logmnrggc_i3gtlo"
...
#   Unknown type 'ROWID' for column 'source_rowid'
  ...
  create_table "mview$_adv_ajg", primary_key: "ajgid#", force: :cascade do |t|
  ...
  create_table "mview$_adv_basetable", id: false, force: :cascade do |t|
  ...
  create_table "mview$_adv_clique", primary_key: "cliqueid#", force: :cascade do |t|
    t.decimal "runid#",                   null: false
  ...
  create_table "mview$_adv_eligible", id: false, force: :cascade do |t|
...
#   Unknown type 'ROWID' for column 'bad_rowid'
  ...
  create_table "mview$_adv_filter", id: false, force: :cascade do |t|
  ...
  create_table "mview$_adv_filterinstance", id: false, force: :cascade do |t|
    t.decimal  "runid#",                     null: false
    t.decimal  "filterid#"
  ...
  create_table "mview$_adv_fjg", primary_key: "fjgid#", force: :cascade do |t|
  ...
  create_table "mview$_adv_gc", primary_key: "gcid#", force: :cascade do |t|
  ...
  create_table "mview$_adv_info", id: false, force: :cascade do |t|
    t.decimal "runid#",              null: false
    t.decimal "seq#",                null: false
    t.decimal "type",                null: false
...
#   Unknown type 'LONG' for column 'text'
  ...
  create_table "mview$_adv_level", id: false, force: :cascade do |t|
    t.decimal "runid#",                null: false
  ...
  create_table "mview$_adv_log", primary_key: "runid#", force: :cascade do |t|
    t.decimal  "filterid#"
...
#   Unknown type 'LONG' for column 'query_text'
  ...
  create_table "mview$_adv_parameters", primary_key: "parameter_name", force: :cascade do |t|
...
#   Unknown type 'LONG' for column 'sql_text'
  ...
  create_table "mview$_adv_rollup", id: false, force: :cascade do |t|
    t.decimal "runid#",    null: false
  ...
  create_table "mview$_adv_sqldepend", id: false, force: :cascade do |t|
...
#   Unknown type 'LONG' for column 'sql_text'
  ...
  create_table "repcat$_audit_attribute", primary_key: "attribute", force: :cascade do |t|
    t.integer "data_type_id",            precision: 38, null: false
    t.integer "data_length",             precision: 38
    t.string  "source",       limit: 92,                null: false
  end

  create_table "repcat$_audit_column", id: false, force: :cascade do |t|
    ...
    t.integer "base_conflict_type_id",            precision: 38, null: false
  ...
  create_table "repcat$_column_group", id: false, force: :cascade do |t|
    t.string "sname",         limit: 30, null: false
    t.string "oname",         limit: 30, null: false
  ...
  create_table "repcat$_conflict", id: false, force: :cascade do |t|
    t.string  "sname",            limit: 30,                null: false
    t.string  "oname",            limit: 30,                null: false
    t.integer "conflict_type_id",            precision: 38, null: false
    t.string  "reference_name",   limit: 30,                null: false
  end

  create_table "repcat$_ddl", id: false, force: :cascade do |t|
    t.decimal "log_id"
    t.string  "source",  limit: 128
    t.string  "role",    limit: 1
    t.string  "master",  limit: 128
    t.integer "line",                 precision: 38
    t.string  "text",    limit: 2000
    t.integer "ddl_num",              precision: 38, default: 1
  end
  ...
  create_table "repcat$_exceptions", primary_key: "exception_id", force: :cascade do |t|
  ...
  create_table "repcat$_extension", primary_key: "extension_id", force: :cascade do |t|
    t.decimal "extension_code"
    t.string  "masterdef",                   limit: 128
    t.string  "export_required",             limit: 1
    t.decimal "repcatlog_id"
    t.decimal "extension_status"
    t.decimal "flashback_scn"
    t.string  "push_to_mdef",                limit: 1
    t.string  "push_to_new",                 limit: 1
    t.decimal "percentage_for_catchup_mdef"
    t.decimal "cycle_seconds_mdef"
    t.decimal "percentage_for_catchup_new"
    t.decimal "cycle_seconds_new"
  end

  create_table "repcat$_flavor_objects", id: false, force: :cascade do |t|
    t.decimal "flavor_id",                                      null: false
    t.string  "gowner",          limit: 30,  default: "PUBLIC", null: false
    ...
    t.decimal "version#"
    t.raw     "hashcode",        limit: 17
    t.raw     "columns_present", limit: 125
  end
  ...
  create_table "repcat$_flavors", id: false, force: :cascade do |t|
    t.decimal  "flavor_id",                                   null: false
    ...
    t.string   "published",     limit: 1,  default: "f"
  end
  ...
  create_table "repcat$_generated", id: false, force: :cascade do |t|
    t.string  "sname",            limit: 30,                null: false
    t.string  "oname",            limit: 30,                null: false
    t.integer "type",                        precision: 38, null: false
    t.decimal "reason"
    t.string  "base_sname",       limit: 30,                null: false
    t.string  "base_oname",       limit: 30,                null: false
    t.integer "base_type",                   precision: 38, null: false
  ...
  create_table "repcat$_grouped_column", id: false, force: :cascade do |t|
    t.string  "sname",       limit: 30, null: false
    t.string  "oname",       limit: 30, null: false
    t.string  "group_name",  limit: 30, null: false
    t.string  "column_name", limit: 30, null: false
  ...
  create_table "repcat$_instantiation_ddl", id: false, force: :cascade do |t|
  ...
  create_table "repcat$_key_columns", id: false, force: :cascade do |t|
    t.string  "sname", limit: 30,                null: false
    t.string  "oname", limit: 30,                null: false
    t.integer "type",             precision: 38
  ...
  create_table "repcat$_object_types", primary_key: "object_type_id", force: :cascade do |t|
    t.string "object_type_name", limit: 200
    t.raw    "flags",            limit: 255
    t.string "spare1",           limit: 4000
  end

  create_table "repcat$_parameter_column", id: false, force: :cascade do |t|
    t.string  "sname",                 limit: 30,                  null: false
    t.string  "oname",                 limit: 30,                  null: false
    t.integer "conflict_type_id",                   precision: 38, null: false
    t.string  "reference_name",        limit: 30,                  null: false
  ...
  create_table "repcat$_priority", id: false, force: :cascade do |t|
    t.string   "sname",            limit: 30,   null: false
    ...
    t.string   "nchar_value",      limit: nil
    t.string   "nvarchar2_value",  limit: nil
    t.string   "large_char_value", limit: 2000
  end

  add_index "repcat$_priority", ["priority_group", "sname"], name: "repcat$_priority_f1_idx"

  create_table "repcat$_priority_group", id: false, force: :cascade do |t|
    t.string  "sname",             limit: 30,                null: false
    t.string  "priority_group",    limit: 30,                null: false
    t.integer "data_type_id",                 precision: 38, null: false
    t.integer "fixed_data_length",            precision: 38
  ...
  create_table "repcat$_refresh_templates", primary_key: "refresh_template_id", force: :cascade do |t|
    t.string   "owner",                 limit: 30,                 null: false
    t.string   "refresh_group_name",    limit: 30,                 null: false
    t.string   "refresh_template_name", limit: 30,                 null: false
    t.string   "template_comment",      limit: 2000
    t.string   "public_template",       limit: 1
    t.datetime "last_modified"
    t.decimal  "modified_by"
    t.datetime "creation_date"
    t.decimal  "created_by"
    t.decimal  "refresh_group_id",                   default: 0.0, null: false
    t.decimal  "template_type_id",                   default: 1.0, null: false
    t.decimal  "template_status_id",                 default: 0.0, null: false
    t.raw      "flags",                 limit: 255
    t.string   "spare1",                limit: 4000
  end
  ...
  create_table "repcat$_repcat", id: false, force: :cascade do |t|
    t.string  "gowner",         limit: 30,                default: "PUBLIC",   null: false
    t.string  "sname",          limit: 30,                                     null: false
    t.string  "master",         limit: 1
    t.integer "status",                    precision: 38
    t.string  "schema_comment", limit: 80
    t.decimal "flavor_id"
    t.raw     "flag",           limit: 4,                 default: "00000000"
  end

  create_table "repcat$_repcatlog", id: false, force: :cascade do |t|
    t.decimal  "version"
    ...
    t.integer  "request",                   precision: 38
    t.string   "oname",        limit: 30
    t.integer  "type",                      precision: 38
    t.string   "a_comment",    limit: 2000
    t.string   "bool_arg",     limit: 1
    t.string   "ano_bool_arg", limit: 1
    t.integer  "int_arg",                   precision: 38
    t.integer  "ano_int_arg",               precision: 38
    t.integer  "lines",                     precision: 38
    t.integer  "status",                    precision: 38
  ...
  create_table "repcat$_repcolumn", id: false, force: :cascade do |t|
    t.string  "sname",       limit: 30,                                       null: false
    t.string  "oname",       limit: 30,                                       null: false
    t.integer "type",                     precision: 38,                      null: false
    t.string  "cname",       limit: 30,                                       null: false
    t.string  "lcname",      limit: 4000
    t.raw     "toid",        limit: 16
    t.decimal "version#"
    t.raw     "hashcode",    limit: 17
    ...
    t.decimal "id"
    t.decimal "pos"
    t.string  "top",         limit: 30
    t.raw     "flag",        limit: 2,                   default: "0000"
    t.decimal "ctype"
    t.decimal "length"
    t.decimal "precision#"
    t.decimal "scale"
  ...
  create_table "repcat$_repgroup_privs", id: false, force: :cascade do |t|
    t.decimal  "userid"
    t.string   "username",    limit: 30, null: false
  ...
  create_table "repcat$_repobject", id: false, force: :cascade do |t|
    t.string  "sname",          limit: 30,                                     null: false
    t.string  "oname",          limit: 30,                                     null: false
    t.integer "type",                      precision: 38,                      null: false
    t.decimal "version#"
    t.raw     "hashcode",       limit: 17
    t.decimal "id"
    t.string  "object_comment", limit: 80
    t.integer "status",                    precision: 38
    t.integer "genpackage",                precision: 38
    t.integer "genplogid",                 precision: 38
    t.integer "gentrigger",                precision: 38
    t.integer "gentlogid",                 precision: 38
    t.string  "gowner",         limit: 30
    t.string  "gname",          limit: 30
    t.raw     "flag",           limit: 4,                 default: "00000000"
  end
  ...
  create_table "repcat$_repprop", id: false, force: :cascade do |t|
    t.string  "sname",             limit: 30,                                null: false
    t.string  "oname",             limit: 30,                                null: false
    t.integer "type",                          precision: 38,                null: false
    t.string  "dblink",            limit: 128,                               null: false
    t.integer "how",                           precision: 38
    t.string  "propagate_comment", limit: 80
    t.decimal "delivery_order"
    t.decimal "recipient_key"
    t.raw     "extension_id",      limit: 16,                 default: "00"
  end
  ...
  create_table "repcat$_repschema", id: false, force: :cascade do |t|
    t.string  "gowner",         limit: 30,  default: "PUBLIC", null: false
    t.string  "sname",          limit: 30,                     null: false
    t.string  "dblink",         limit: 128,                    null: false
    t.string  "masterdef",      limit: 1
    t.string  "snapmaster",     limit: 1
    t.string  "master_comment", limit: 80
    t.string  "master",         limit: 1
    t.decimal "prop_updates",               default: 0.0
    t.string  "my_dblink",      limit: 1
    t.raw     "extension_id",   limit: 16,  default: "00"
  end
  ...
  create_table "repcat$_resol_stats_control", id: false, force: :cascade do |t|
    t.string   "sname",                 limit: 30,                null: false
    t.string   "oname",                 limit: 30,                null: false
    t.datetime "created",                                         null: false
  ...
  create_table "repcat$_resolution", id: false, force: :cascade do |t|
    t.string  "sname",              limit: 30,                null: false
    t.string  "oname",              limit: 30,                null: false
    t.integer "conflict_type_id",              precision: 38, null: false
    t.string  "reference_name",     limit: 30,                null: false
  ...
  create_table "repcat$_resolution_method", id: false, force: :cascade do |t|
    t.integer "conflict_type_id",            precision: 38, null: false
    t.string  "method_name",      limit: 80,                null: false
  end

  create_table "repcat$_resolution_statistics", id: false, force: :cascade do |t|
    t.string   "sname",             limit: 30,                  null: false
    t.string   "oname",             limit: 30,                  null: false
    t.integer  "conflict_type_id",               precision: 38, null: false
    t.string   "reference_name",    limit: 30,                  null: false
  ...
  create_table "repcat$_site_objects", id: false, force: :cascade do |t|
  ...
  create_table "repcat$_sites_new", id: false, force: :cascade do |t|
    t.raw     "extension_id",       limit: 16,  null: false
    t.string  "gowner",             limit: 30,  null: false
    t.string  "gname",              limit: 30,  null: false
    t.string  "dblink",             limit: 128, null: false
    t.string  "full_instantiation", limit: 1
    t.decimal "master_status"
  end
  ...
  create_table "repcat$_snapgroup", id: false, force: :cascade do |t|
    t.string  "gowner",        limit: 30,  default: "PUBLIC"
    t.string  "gname",         limit: 30
  ...
  create_table "repcat$_template_objects", primary_key: "template_object_id", force: :cascade do |t|
    ...
    t.decimal "object_type",                                     null: false
    t.decimal "object_version#"
    t.text    "ddl_text"
    t.string  "master_rollback_seg",  limit: 30
    t.string  "derived_from_sname",   limit: 30
    t.string  "derived_from_oname",   limit: 30
    t.decimal "flavor_id"
    t.string  "schema_name",          limit: 30
    t.decimal "ddl_num",                           default: 1.0, null: false
    t.decimal "template_refgroup_id",              default: 0.0, null: false
    t.raw     "flags",                limit: 255
    t.string  "spare1",               limit: 4000
  end
  ...
  create_table "repcat$_template_refgroups", primary_key: "refresh_group_id", force: :cascade do |t|
    t.string  "refresh_group_name",  limit: 30,  null: false
    t.decimal "refresh_template_id",             null: false
  ...
  create_table "repcat$_template_status", primary_key: "template_status_id", force: :cascade do |t|
    t.string "status_type_name", limit: 100, null: false
  end

  create_table "repcat$_template_targets", primary_key: "template_target_id", force: :cascade do |t|
  ...
  create_table "repcat$_template_types", primary_key: "template_type_id", force: :cascade do |t|
    t.string "template_description", limit: 200
    t.raw    "flags",                limit: 255
    t.string "spare1",               limit: 4000
  end
